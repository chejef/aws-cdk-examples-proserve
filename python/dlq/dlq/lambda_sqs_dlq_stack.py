...
class LambdaSQSDlqStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        queue = sqs.Queue(self, "sqs", retention_period=core_lambda.retention_period,
                          visibility_timeout=core_lambda.visibility_timeout,
                          dead_letter_queue=sqs.DeadLetterQueue(max_receive_count=core_lambda.sqs_max_receives,
                                                                queue=dlq))
        # create lambda function.
        function = _lambda.Function(self, "lambda", function_name="dlq_lambda", runtime=_lambda.Runtime.PYTHON_3_9,
